...
from ailang.compiler.modules.virtual_memory import VirtualMemoryOps  # Kernel mode
from ailang.compiler.modules.virtual_memory_usermode import VirtualMemoryOpsUserMode  # User mode
